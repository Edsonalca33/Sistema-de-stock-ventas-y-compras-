...
public class ConsultarCompras extends javax.swing.JDialog {
    ...
    public ConsultarCompras(java.awt.Frame parent, boolean modal) {
        ...
        label_simbolo.setText( c.getsimbolo_moneda());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Consultas de Compras");
        ...
        label_simbolo.setFont(new java.awt.Font("Tahoma", 1, 14)); // NOI18N
        label_simbolo.setText("S/.");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                    ...
                                    .addComponent(label_simbolo, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))))
        ...
        getAccessibleContext().setAccessibleName("Listar ");
    ...
    private void jButtonBuscarFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarFiltroActionPerformed
        ...
        cc.buscarFacturasdeCompras2(parametroBusqueda );
...
//        label_ganancia.setText("click en buscar");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ConsultarCompras.class.getName()).log(Level.SEVERE, null, ex);
        }
...
/*                    Date fechaActual = new Date();
  ...
  */      
      ...
      //  String parametroBusqueda = jDateChooser_fecha.getText(); 
        cc.buscarFacturasdeComprasFecha(fecha,fecha2 );
                                                                                                   int[] anchos = {35, 150, 400, 70, 70};
        for (int i = 0; i < jTableListarVentas.getColumnCount(); i++) {
            jTableListarVentas.getColumnModel().getColumn(i).setPreferredWidth(anchos[i]);
        }
    ...
    private javax.swing.JLabel label_simbolo;

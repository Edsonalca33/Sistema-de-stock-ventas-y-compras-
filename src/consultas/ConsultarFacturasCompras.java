 ...
 * @author Sergio
 */
public class ConsultarFacturasCompras extends javax.swing.JDialog {
    ...
    public ConsultarFacturasCompras(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        getAccessibleContext().setAccessibleName("Listar  Proveedores");
    ...
    private void jButtonBuscarFiltroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarFiltroActionPerformed
        ...
        try {
            ...
            cc.buscarFacturasCompras(parametroBusqueda, buscarPorFacturas, buscarPorCliente, buscarPorFecha);
            int[] anchos = {300, 200, 150, 150};
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(ConsultarFacturasCompras.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsultarFacturasCompras.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ConsultarFacturasCompras dialog = new ConsultarFacturasCompras(new javax.swing.JFrame(), true);
